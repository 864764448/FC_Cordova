...
- (BOOL)webView:(UIWebView*)webView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if (![urlString isEqualToString:@"gap://ready"]&&![urlString isEqualToString:@"about:blank"]) {
        
    [[NSNotificationCenter defaultCenter]postNotificationName:@"saveUrl" object:urlString];

    
    [[NSNotificationCenter defaultCenter]postNotificationName:@"webMessage" object:urlString];
       }
